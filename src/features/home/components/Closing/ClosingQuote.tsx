    ...
    <section className="py-24 border-t border-border">
      <div className="container text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          <Button asChild size="lg" className="rounded-full w-full sm:w-auto hover:scale-105 transition-transform">
            <Link to="/dados">
              <BarChart3 className="w-5 h-5 mr-2 -ml-1" />
              Explorar o Banco de Dados
            </Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="rounded-full w-full sm:w-auto hover:bg-muted/50 transition-colors">
            <Link to="/sobre">
