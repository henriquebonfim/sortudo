...
export function HeroSection({ id }: { id?: string }) {
  const { totalBillions, fractionBillions, drawCount, yearsOfOperation, totalJackpotWinners, totalPrizeDistributed } = useAggregatedRevenue();
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold tracking-tight text-balance text-foreground leading-[1.05] mb-6">
              A <span className="text-gradient-gold underline decoration-primary/40">sorte</span>{" "}
              é um{" "}
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0 mb-10">
              Descubra como a matemática explica a Mega-Sena, quanto os brasileiros já apostaram,
              e por que o sistema é desenhado para a casa nunca perder.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-border/30 hover:border-primary hover:text-black text-muted-foreground font-display font-semibold text-base px-8 py-6 rounded-2xl transition-all w-full sm:w-auto"
              >
                <Link to="/buscar">
          ...
          >
            ...
            >
              ...
              <dt className="stat-label text-xs md:text-sm mb-3">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  <p className="stat-label text-[10px] mb-1">Total de Premiação distribuida</p>
                  <p className="font-mono font-semibold text-primary text-sm">R$ {(totalPrizeDistributed / 1_000_000_000).toLocaleString('pt-BR', { maximumFractionDigits: 2 })} bi</p>
                </div>
                <div>
