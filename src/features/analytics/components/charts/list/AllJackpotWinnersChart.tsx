...
import { ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ListIcon, MapPin, Trophy } from 'lucide-react';
...
export function AllJackpotWinnersChart() {
  ...
  return (
    <div className="space-y-6">
      ...
      {totalPages > 1 && (
        <div className="flex justify-between flex-row items-center pt-2">
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-[10px] font-bold font-mono min-w-[60px] text-center">
