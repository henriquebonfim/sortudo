...
import { calculateTrueExpectedValue } from '../../../lib/statistical';
import { TICKET_PRICE, TOTAL_COMBINATIONS } from '@/lib/lottery/constants';
...
export function TrueNetEVChart() {
  const chartData = useMemo(() => {
    ...
    const secondaryPrizesEV = 1.2; // Average R$ from smaller prizes (Quina/Quadra)
