import { useParityDistribution } from '@/features/analytics/hooks/use-analytics';
import { useLotteryMeta } from '@/store/selectors';
import { useMemo } from 'react';
import { Legend } from '@/features/analytics/components/charts/Legend';
import { ParityBar } from '@/features/analytics/components/charts/ParityBar';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {data.map((d, i) => (
          <ParityBar key={d.label} data={d} maxPct={maxPct} totalItems={raw.length} index={i} />
        ))}
      </div>
