...
import { BRAZIL_STATES_PATH_DATA } from '@/features/analytics/components/charts/brazil-map.data';
import { GeoDataPoint } from '@/features/analytics/components/charts/geo.types';
