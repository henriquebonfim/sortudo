    ...
    <div className="space-y-4">
      <div className="glass-card p-6 border-l-4 border-l-emerald-500/50">
        ...
        <p className="text-sm text-slate-300 mb-6 max-w-2xl leading-relaxed">
          Os prêmios anunciados são baseados em anuidades de 30 anos. Se você optar pelo valor em
          dinheiro vivo (o que, matematicamente, você provavelmente deveria fazer), você perde
          instantaneamente ~52% do valor anunciado. E então vêm os impostos.
          <br />
          <br />
          <strong>A Realidade:</strong> Aquele anúncio dizendo "1 BILHÃO DE DÓLARES!" representa, na
          verdade, um cheque de ~$300 milhões. Combine isso com o risco de Divisão (curva de
          Poisson), e o valor real cai ainda mais.
        </p>
          ...
          >
            ...
            <Tooltip
              ...
              formatter={(value: number) => [
                `$${(value / 1_000_000).toFixed(0)} Milhões`,
                'Quantia',
              ]}
            />
