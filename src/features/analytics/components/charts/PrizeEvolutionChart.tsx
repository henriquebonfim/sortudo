      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="glass-card p-4 flex items-center gap-4 border-emerald-500/10 bg-emerald-500/5">
          ...
          <div>
            ...
            <p className="text-lg font-display font-bold text-foreground">
              {globalInsights?.efficiency.toFixed(1)}% <span className="text-[10px] text-muted-foreground font-normal">da arrecadação</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-[10px] sm:text-xs">
            ...
            >
              <div className="w-3 h-0.5 border-t border-dashed" style={{ borderColor: CHART_COLORS.BLUE }} />
              Distribuído
            </button>
            <button
        ...
        <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="p-2 rounded bg-background/50 border border-border">
                    <p className="text-[9px] text-muted-foreground uppercase font-bold">Arrecadação</p>
                    <p className="text-sm font-mono font-bold text-emerald-500">
                      {formatCompactCurrency(selectedData.totalRevenue)}
                    </p>
                  </div>
                  <div className="p-2 rounded bg-background/50 border border-border">
                    <p className="text-[9px] text-muted-foreground uppercase font-bold">Total Prêmios</p>
          ...
          <div className="glass-card p-4 space-y-4">
            ...
            <div className="space-y-4">
              {MILESTONES.map(m => (
                <div key={m.year} className="flex gap-3 group cursor-pointer" onClick={() => setSelectedYear(m.year)}>
                  <div
                    className="w-7 h-7 rounded-lg flex-shrink-0 flex items-center justify-center border transition-all group-hover:scale-110"
                    style={{ borderColor: `${m.color}30`, backgroundColor: `${m.color}10`, color: m.color }}
                  >
                    {m.icon}
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-foreground leading-none mb-0.5">{m.year}</p>
