import { PrizeDistributionChart } from '@/features/analytics/components/charts/hierarchical/PrizeDistributionChart';
import { RegularVsSpecialChart } from '@/features/analytics/components/charts/comparison/RegularVsSpecialChart';
import { StreakEconomicsChart } from '@/features/analytics/components/charts/statistical/StreakEconomicsChart';
import { StreakFrequencyChart } from '@/features/analytics/components/charts/statistical/StreakFrequencyChart';
import { TopJackpotWinnersChart } from '@/features/analytics/components/charts/list/TopJackpotWinnersChart';
import { JackpotErosionWaterfall } from '@/features/analytics/components/charts/economics/JackpotErosionWaterfall';
import { TrueNetEVChart } from '@/features/analytics/components/charts/statistical/TrueNetEVChart';
...
export const getEconomicsChapter = (_stats?: LotteryStats | null): Chapter => ({
  ...
  sections: [
    ...
    },
    {
      ...
      type: 'Informational',
      insight:
        'Mais de 21% de todos os prêmios são ganhos no primeiro sorteio (Streak 0). Sequências com mais de 10 acúmulos são eventos matematicamente raros.',
    ...
    },
    {
      ...
      type: 'Statistical',
      insight:
        'O valor real do bilhete afunda quando o prêmio passa do ponto de equilíbrio, porque as vendas explodem e o risco de dividir o prêmio zera sua vantagem matemática.',
    ...
    },
    {
      ...
      type: 'Informational',
      insight:
        'Prêmios bilionários anunciados representam anuidades de 30 anos. A opção Cash subtrai ~50%, e os impostos devoram mais 43% do que sobra. O take-home real é em torno de 30%.',
    ...
    },
    {
      ...
      type: 'List',
      insight: `O recorde histórico é de ${_stats?.topJackpotWinners?.[0]?.winners || 52} ganhadores simultâneos na Sena — o que diluiu drasticamente o prêmio individual naquele sorteio.`,
