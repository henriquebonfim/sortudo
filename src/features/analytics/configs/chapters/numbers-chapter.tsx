import { BubbleChart } from '@/features/analytics/components/charts/statistical/BubbleChart';
import { FrequencyBarChart } from '@/features/analytics/components/charts/statistical/FrequencyBarChart';
...
import { RecentHotNumbersChart } from '@/features/analytics/components/charts/list/RecentHotNumbersChart';
...
export const getNumbersChapter = (stats?: LotteryStats | null): Chapter => ({
  ...
  sections: [
    ...
    },
    {
      ...
      type: 'Informational',
      insight:
        'A distribuição baixo/alto é quase perfeita (49.5% / 50.5%). Números primos representam ~29% — próximo da proporção de primos no universo 1-60 (30%).',
