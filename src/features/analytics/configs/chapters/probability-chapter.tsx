...
import { LifetimesToWinChart } from '@/features/analytics/components/charts/simulator/LifetimesToWinChart';
import { LLNConvergenceChart } from '@/features/analytics/components/charts/statistical/LLNConvergenceChart';
...
export const getProbabilityChapter = (_stats?: LotteryStats | null): Chapter => ({
  ...
  sections: [
    ...
    },
    {
      ...
      type: 'Statistical',
      insight:
        "A longo prazo, a aleatoriedade é matematicamente perfeita. A percepção de que um número está 'atrasado' ou 'quente' é apenas ruído no curto prazo.",
    ...
    },
    {
      ...
      type: 'Statistical',
      insight:
        'Simulamos um jogador comprando 100 bilhetes por semana durante incontáveis vidas de 80 anos. A chance percentual de chegar ao leito de morte sem nunca ganhar nunca chega a zero realístico.',
