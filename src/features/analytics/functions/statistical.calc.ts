import { ANALYSIS_CONFIG, BALLS_PER_DRAW, MAX_LOTTERY_NUMBER } from '@/lib/lottery/constants';
 ...
 * Based on Hypergeometric Distribution for Mega-Sena (6/60).
 */
export function calculateTheoreticalParity(label: string): number {
  const THEORETICAL_MAP: Record<string, number> = {
    '0O/6E': 1.2,
    '1O/5E': 8.5,
    '2O/4E': 23.8,
    '3O/3E': 32.9,
  ...
  return THEORETICAL_MAP[label] || 0;
}
