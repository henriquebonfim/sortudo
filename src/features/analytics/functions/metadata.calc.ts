import { Game, LotteryMetadata, TopJackpotWinnersDraw } from '@/lib/lottery/types';
import { calculatePercentage, sum } from '@/lib/lottery/utils';
import { ANALYSIS_CONFIG } from '@/lib/lottery/constants';
