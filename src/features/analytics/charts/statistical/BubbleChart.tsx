  ...
  return (
    <>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard label="Total ganhadores" value={meta.totalJackpotWinners.toLocaleString("pt-BR")} variant="brand" />
        <StatCard label="Nº mais sorteado" value={`${data.max.number} (${data.max.frequency}x)`} variant="brand" />
      </div>
