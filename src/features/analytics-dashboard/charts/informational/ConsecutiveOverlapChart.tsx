...
export default function ConsecutiveOverlapChart() {
  ...
  const chartData = useMemo(() => {
    ...
    return [
      ...
      { name: "2+ Repetidos", value: Number((overlaps.two + overlaps.threePlus).toFixed(2)), color: CHART_COLORS.AMBER },
    ];
  }, [overlaps]);
  ...
  return (
    <div className="glass-card p-4 flex flex-col items-center">
      <h4 className="text-sm font-semibold mb-1 text-slate-200 w-full text-center">Números Repetidos</h4>
      <p className="text-[10px] text-muted-foreground mb-4 text-center">Frequência em que números do sorteio anterior se repetem no atual.</p>
