...
export default function JackpotErosionWaterfall() {
          ...
          >
            ...
            <Bar dataKey="value" radius={[0, 6, 6, 0]} maxBarSize={40}>
               ...
               <LabelList 
                 ...
                 position="right" 
                 style={{ fill: '#E2E8F0', fontSize: 13, fontWeight: 'bold', fontFamily: "monospace" }} 
               />
            </Bar>
          </BarChart>
        </ResponsiveContainer>
