...
import { calculateTrueExpectedValue } from "@/domain/math/statistics";

export default function TrueNetEVChart() {
        ...
        <ResponsiveContainer width="100%" height={400}>
          <LineChart data={chartData} margin={{ left: 10, right: 30, top: 20, bottom: 40 }}>
            ...
            <Line 
              ...
              strokeWidth={3}
              dot={false}
              activeDot={{ r: 6, fill: CHART_COLORS.EMERALD, stroke: "#1E293B", strokeWidth: 2 }}
            />
          </LineChart>
        </ResponsiveContainer>
      </div>
