...
import { FileSpreadsheet, Database, PieChart, Lightbulb, CheckCircle2 } from "lucide-react";
...
const STEPS = [
  {
    ...
    description: "Leitura do Excel oficial contendo todos os sorteios desde o concurso #1.",
    color: "text-blue-400",
    bg: "bg-blue-400/10",
  },
  {
      ...
      <div className="relative space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 relative z-10">
          {STEPS.map((step, i) => {
            ...
            return (
              ...
              >
                <div className={`relative flex-shrink-0 w-12 h-12 rounded-xl border flex items-center justify-center transition-all duration-500 ${
        ...
        <div className="mt-8 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
           ...
           <p className="text-[10px] text-muted-foreground italic max-w-[200px] text-center sm:text-right">
             Seu navegador está processando {">"}2.700 registros em tempo real.
           </p>
        </div>
      </div>
    </div>
